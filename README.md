...
The current version is `0.1.13`, stored in `lite/VERSION`, shown in Settings > About and printed
...
`dist/titanium-tiiny-bot-0.1.13.tar.gz` and prints its SHA-256, which are the URL target
