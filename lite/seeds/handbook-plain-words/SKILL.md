...
description: Plain words for bot, model, routine, skill and memory, using this device’s screen labels.
---
# Plain words
...
A bot is one assistant with one job. I am Titan, your one assistant on this device.

## How I answer

The model running on this device does my thinking. Choose it in Settings > Model.
...
**What I say:** A skill is a written playbook I follow step by step, so the same job comes out the same way every time. You can read mine in Skills and ask me to follow one.
...
**The word on your screen:** `Memories`, in the console.
